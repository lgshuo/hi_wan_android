      ...
      child: AnimatedContainer(
        ...
        child: Stack(
          children: [
                ...
                child: Container(
                  ...
                  child: AnimatedBuilder(
                    child: GestureDetector(
                      ...
                      child: InkWell(
                          onTap: () {
                            widget.onSearchTap(_serchContext);
                          },
            ...
            Material(
              /// can add custom color or the color will be white
              color: toggle == 1 ? widget.color : widget.preColor,
              borderRadius: BorderRadius.circular(30.0),
              child: IconButton(
                splashRadius: 19.0,
                ...
                icon: widget.prefixIcon != null
                    ? toggle == 1
                        ...
                        : widget.prefixIcon!
                    : Icon(toggle == 1 ? Icons.close : Icons.search,
                        size: 20.0, color: widget.iconColor),
                onPressed: () {
                  setState(
                    () {
