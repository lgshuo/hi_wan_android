...
class ProjectItemPage extends StatefulWidget {
  ...
  @override
  _ProjectItemPageState createState() {
    return _ProjectItemPageState();
  }
}

class _ProjectItemPageState extends State<ProjectItemPage> with  AutomaticKeepAliveClientMixin{
  @override
